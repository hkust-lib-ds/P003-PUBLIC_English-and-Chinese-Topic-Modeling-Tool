...
```mermaid
graph TD;
    A[主介面 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Upload-documents'>上載文件並完成與時間模型相關的設定</a>] --> B[側邊欄 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Train-model'>設定模型參數與選擇停用詞表來訓練模型</a>];
B[側邊欄 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Train-model'>設定模型參數與選擇停用詞表來訓練模型</a>] --> C[主介面 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Visualization'>可視化你的探索成果</a>];
C[主介面 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Visualization'>可視化你的探索成果</a>] --> D[側邊欄 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Topic-display'>客製化你的主題展示</a>];
D[側邊欄 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Topic-display'>客製化你的主題展示</a>] --> E[主介面 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Export'>留存屬於你的主題模型與相關數據</a>];
E[主介面 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Export'>留存屬於你的主題模型與相關數據</a>] --> F[主介面 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Predict'>上傳新的數據 應用你訓練完成的模型預測主題結果</a> <br/>你亦可以選擇上傳先前留存的模型，以作進一步的研究與分析: 側邊欄 <a href='https://github.com/hkust-lib-ds/P003-PUBLIC_English-and-Chinese-Topic-Modeling-Tool/blob/main/manual_chi.md#Import'>上傳先前儲存的模型</a>];
