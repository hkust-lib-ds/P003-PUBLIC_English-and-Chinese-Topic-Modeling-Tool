...
#mpl.rcParams['font.sans-serif'] = ['Tahoma', 'DejaVu Sans', 'Lucida Grande', 'Verdana', 'Source Han Sans', 'Simhei']

def visualize_wordcloud(trained_model, topic, max_num_words, min_word_length):
    text = {word: value for word, value in trained_model.get_topic(topic)}
    wc = WordCloud(background_color="white", max_words=max_num_words, min_word_length=min_word_length, font_path='Library/Fonts/PingFang_Bold.ttf')
...
def visualize_document_datamap(
    ...
    **datamap_kwds,
    ...
    #cn_font = fm.FontProperties(fname = 'Library/Fonts/PingFang_Bold.ttf')
    #cn_font = fm.FontProperties()
    #cn_font.set_family('SimHei')
